...
- We conducted a molecular docking analysis on the de novo molecules generated from DrugGEN and other target-based generation models, including RELATION, TRIOMHPHE-BOA, ResGen, TargetDiff and Pocket2Mol as well as on real AKT1 and CDK2 inhibitors, using the crystal structure of [AKT1](https://www.rcsb.org/structure/4gv1) and [CDK2](https://www.rcsb.org/structure/4kd1), respectively. The median kcal/mol values of the top 10% of molecules, based on docking scores, were compared among target-based methods for evaluation. These top 10% molecules for DrugGEN, for both AKT1 and CDK2, can be found [here](generated_molecules/DrugGEN_generated_molecules_docking_top10.csv)
