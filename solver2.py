        ...
        for idx in range(self.num_iters):
            ...
            for i, data in enumerate(self.loader):   
                ...
                if (idx+1 > self.warm_up_steps) & (i+1 > 10):
                    ...
                    tra_edges_logits, tra_nodes_logits, dec_attn = self.G2(edges_logits, nodes_logits,prot_n,prot_e)
                ...
                if (i+1) % self.n_critic == 0:
                    ...
                    if ((idx+1 > self.warm_up_steps) & ((i+1) % self.n_critic == 0)):
                        ...
                        g_tra_edges_logits, g_tra_nodes_logits, g_dec_attn= self.G2(g_edges_logits, g_nodes_logits,prot_n,prot_e)
                ...
                if (i+1) % (self.log_step) == 0:
                    ...
                    # Log update
                    m0, m1 = all_scores(fake_mol, mols,self.vertexes, norm=True)     # 'mols' is output of Fake Reward
