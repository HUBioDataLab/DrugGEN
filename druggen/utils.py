...
def gradient_penalty(y, x, device):
    ...
    weight = torch.ones(y.size(),requires_grad=False).to(device)
...
def matrices2mol(node_labels=None, edge_labels=None, atom_decoders=None, bond_decoders=None, strict=True, file_name=None):
    mol = Chem.RWMol()
    RDLogger.DisableLog('rdApp.*') 
