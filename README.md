...
python DrugGEN/main.py --submodel --mode="train" --device="cuda" --raw_file="DrugGEN/data/chembl_smiles.smi" --dataset_file="chembl45_train.pt" -- drug_raw_file="akt_train.smi" --drug_dataset_file="drugs_train.pt" --max_atom=45
```
