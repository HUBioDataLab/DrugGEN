...
SMILES notations of the de novo generated molecules from DrugGEN and DrugGEN-NoTarget models, along with their deep learning-based bioactivity prediction results (DeepScreen), docking and MD analysis results, and filtering results, can be accessed under the [paper_results](paper_results) folder. The structural representations of the selected molecules are depicted in the figure below.
