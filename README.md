...
python DrugGEN/main.py --submodel --mode="train" --device="cuda" --raw_file="DrugGEN/data/chembl_train.smi" --dataset_file="chembl45_train.pt" -- drug_raw_file="akt_train.smi" --drug_dataset_file="drugs_train.pt" --max_atom=45
```
...
<<<<<<< HEAD
- First, please download the model weights from the given [link]{https://drive.google.com/drive/folders/19knQAtpieSamaxB4L5ft8bFiCVikBFDS?usp=share_link} and place it in the folder: "DrugGEN/experiment/models/".
