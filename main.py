...
if __name__ == '__main__':
    ...
    parser.add_argument('--g_conv_dim',default=[64,128,256], help='number of conv filters in the first layer of G')
    ...
    parser.add_argument('--heads', type=int, default=32, help='Number of head for Attention.')
    ...
    parser.add_argument('--warm_up_steps', type=float, default=1000000, help='.')
